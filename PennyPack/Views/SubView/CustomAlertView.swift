...
#Preview {
    CustomAlertView(shoppingViewModel: ShoppingManager(), listViewModel: ListViewModel(), isAlertPresented: .constant(false), isFinishPresented: .constant(false), totalPriceWon: .constant(0), totalPriceEuro: .constant(0.0))
}
